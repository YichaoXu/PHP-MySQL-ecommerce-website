...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement->execute(array(
                                        ...
                                        (empty($_POST['cust_country']) ? 0 : strip_tags($_POST['cust_country'])),
                                        ...
                                        '',
                                        '',
                                        (empty($_POST['cust_b_country']) ? 0 : strip_tags($_POST['cust_b_country'])),
                                        '',
                                        '',
                                        '',
                                        '',
                                        ...
                                        '',
                                        '',
                                        (empty($_POST['cust_s_country']) ? 0 : strip_tags($_POST['cust_s_country'])),
                                        '',
                                        '',
                                        '',
                                        '',
